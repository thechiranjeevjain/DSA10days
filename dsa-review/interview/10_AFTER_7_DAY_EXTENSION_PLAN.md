...
| 184 | Hotel Reviews | [Java](../../src/main/java/org/chijai/day10/session1/trie/HotelReviews.java) | Trie | Trie / ranking | Use trie or keyword set to count good words per review, then rank hotels by score. |  |  |  |
| 185 | Design Fraud Pattern Detection | [Java](../../src/main/java/org/chijai/design/lld/DesignFraudPatternDetection.java) | Design Data Structures | LLD / domain modeling | Define which transaction events are retained and which rule/window makes a pattern fraudulent. |  |  |  |
| 186 | Api Integration Example | [Java](../../src/main/java/org/chijai/design/lld/ApiIntegrationExample.java) | Design Data Structures | LLD/API integration | Model request, response, retry, timeout, and idempotency boundaries explicitly. |  |  |  |
| 187 | Design Redis | [Java](../../src/main/java/org/chijai/design/lld/DesignRedis.java) | Design Data Structures | LLD / data structures | Key-value operations need storage, expiry metadata, and eviction/cleanup policy. |  |  |  |
| 188 | Design Token Bucket Rate Limiter | [Java](../../src/main/java/org/chijai/design/lld/DesignTokenBucketRateLimiter.java) | Design Data Structures | LLD / rate limiting | A bucket refills by elapsed time and each request consumes one token if available. |  |  |  |
| 189 | Best Time to Buy and Sell Stock with Transaction Fee | [Java](../../src/main/java/org/chijai/day1/Arrays/session3/StockSeries2.java) / [LC](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee/) | Dynamic Programming | Stock DP variants | Fee changes the sell transition; hold/cash states prevent double-counting fees. |  |  |  |
| 190 | Best Time to Buy and Sell Stock with Cooldown | [Java](../../src/main/java/org/chijai/day1/Arrays/session3/StockSeries2.java) / [LC](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/) | Dynamic Programming | Stock DP variants | Cooldown creates three states: hold, sold today, and rest. |  |  |  |
| 191 | Best Time to Buy and Sell Stock III | [Java](../../src/main/java/org/chijai/day1/Arrays/session3/StockSeries1.java) / [LC](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iii/) | Dynamic Programming | Greedy / DP states | Four states track first buy, first sell, second buy, second sell. |  |  |  |
| 192 | Best Time to Buy and Sell Stock IV | [Java](../../src/main/java/org/chijai/day1/Arrays/session3/StockSeries2.java) / [LC](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iv/) | Dynamic Programming | Stock DP variants | For k transactions, each transaction layer has a hold and cash state. |  |  |  |
| 193 | Distinct Subsequences II | [Java](../../src/main/java/org/chijai/day10/session2/CountUniqueChars.java) / [LC](https://leetcode.com/problems/distinct-subsequences-ii/) | Dynamic Programming | Contribution counting | Each char doubles subsequences, then subtracts subsequences counted before its previous occurrence. |  |  |  |
| 194 | Word Break | [Java](../../src/main/java/org/chijai/day9/dp/session2/CoinChange.java) / [LC](https://leetcode.com/problems/word-break/) | Dynamic Programming | Unbounded knapsack DP | dp[i] means prefix s[0..i) can be segmented into dictionary words. |  |  |  |
| 195 | Interleaving String | [Java](../../src/main/java/org/chijai/day9/dp/session2/EditDistance.java) / [LC](https://leetcode.com/problems/interleaving-string/) | Dynamic Programming | 2D DP | dp[i][j] says s3 prefix i+j can be formed by prefixes of s1 and s2. |  |  |  |
...
| Rank | Problem | Links | Family | Pattern | Signal / Invariant | Score | Failure | Next Review |
|---:|---|---|---|---|---|---|---|---|
| 196 | Longest Common Subsequence | [Java](../../src/main/java/org/chijai/day9/dp/session2/EditDistance.java) / [LC](https://leetcode.com/problems/longest-common-subsequence/) | Dynamic Programming | 2D DP | dp[i][j] is the best subsequence length between two prefixes. |  |  |  |
| 197 | Delete Operation for Two Strings | [Java](../../src/main/java/org/chijai/day9/dp/session2/EditDistance.java) / [LC](https://leetcode.com/problems/delete-operation-for-two-strings/) | Dynamic Programming | 2D DP | Minimum deletions equals removing everything not in the LCS. |  |  |  |
| 198 | Longest Palindromic Subsequence | [Java](../../src/main/java/org/chijai/day9/dp/session2/EditDistance.java) / [LC](https://leetcode.com/problems/longest-palindromic-subsequence/) | Dynamic Programming | 2D DP | dp[l][r] is best palindrome subsequence inside s[l..r]. |  |  |  |
| 199 | Minimum ASCII Delete Sum for Two Strings | [Java](../../src/main/java/org/chijai/day9/dp/session2/EditDistance.java) / [LC](https://leetcode.com/problems/minimum-ascii-delete-sum-for-two-strings/) | Dynamic Programming | 2D DP | dp[i][j] is minimum ASCII deletion cost to make two prefixes equal. |  |  |  |
| 200 | Climbing Stairs | [Java](../../src/main/java/org/chijai/day9/dp/session2/CoinChange.java) / [LC](https://leetcode.com/problems/climbing-stairs/) | Dynamic Programming | Unbounded knapsack DP | Ways to reach n comes from n-1 plus n-2, with two rolling counts. |  |  |  |
| 201 | Min Cost Climbing Stairs | [Java](../../src/main/java/org/chijai/day9/dp/session2/CoinChange.java) / [LC](https://leetcode.com/problems/min-cost-climbing-stairs/) | Dynamic Programming | Unbounded knapsack DP | Cost to stand on step i is cost[i] plus min(previous one, previous two). |  |  |  |
| 202 | Perfect Squares | [Java](../../src/main/java/org/chijai/day9/dp/session2/CoinChange.java) / [LC](https://leetcode.com/problems/perfect-squares/) | Dynamic Programming | Unbounded knapsack DP | dp[x] is the fewest square numbers summing to x; try each square as the last move. |  |  |  |
| 203 | Number of Longest Increasing Subsequence | [Java](../../src/main/java/org/chijai/day9/dp/session2/LIS.java) / [LC](https://leetcode.com/problems/number-of-longest-increasing-subsequence/) | Dynamic Programming | DP / patience sorting | Track both LIS length ending at i and how many ways achieve that length. |  |  |  |
| 204 | Russian Doll Envelopes | [Java](../../src/main/java/org/chijai/day9/dp/session2/LIS.java) / [LC](https://leetcode.com/problems/russian-doll-envelopes/) | Dynamic Programming | DP / patience sorting | Sort width ascending, height descending for equal width, then LIS on heights. |  |  |  |
| 205 | Maximum Length of Pair Chain | [Java](../../src/main/java/org/chijai/day9/dp/session2/LIS.java) / [LC](https://leetcode.com/problems/maximum-length-of-pair-chain/) | Intervals / Sorting Greedy | DP / patience sorting | Sort pairs by end and take the next pair whose start is after the current end. |  |  |  |
| 206 | Longest Continuous Increasing Subsequence | [Java](../../src/main/java/org/chijai/day9/dp/session2/LIS.java) / [LC](https://leetcode.com/problems/longest-continuous-increasing-subsequence/) | Sliding Window | DP / patience sorting | Continuous means subarray, so reset the current streak whenever nums[i] <= nums[i-1]. |  |  |  |
