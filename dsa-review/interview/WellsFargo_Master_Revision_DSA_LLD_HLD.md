...
| 6 | **3Sum** | [15. 3Sum](https://leetcode.com/problems/3sum/) | [3Sum](../../src/main/java/org/chijai/day1/Arrays/session2/Three3Sum2Sum.java) | sort + two pointers | **15m / 22m stop** | Sort; fix one number; solve 2Sum on the suffix; skip duplicates. | Unique triplets only; duplicate handling correct; O(n²); can explain why sorting enables two pointers. |  |
...
| 10 | **Merge Intervals** | [56. Merge Intervals](https://leetcode.com/problems/merge-intervals/) | [Merge Intervals](../../src/main/java/org/chijai/day1/Arrays/session4/Intervals/Intervals.java) | sort + linear merge | **10m / 15m stop** | Sort by start; compare next start with current merged end. | Correct overlap rule; handles nested/touching intervals per requirement; O(n log n); no unnecessary data structures. |  |
