...
flowchart TD
  ...
  Sub01 --> Sub01A01["ANCHOR<br/>rank 105: Count Number Of Nice Subarrays"]
  Invariant --> Sub02["SUB-PATTERN<br/>Sliding window<br/>1 problem(s)"]
  Sub02 --> Sub02A01["ANCHOR<br/>rank 47: Longest Substring With At Most K Distinct Characters"]
  Invariant --> Sub03["SUB-PATTERN<br/>Sliding window / need-have<br/>1 problem(s)"]
  ...
  Sub05 --> Sub05A01["ANCHOR<br/>rank 52: Find All Anagrams In A String"]
```
