...
flowchart TD
  ...
  Sub02 --> Sub02A01["ANCHOR<br/>rank 163: Spiral Matrix"]
  Invariant --> Sub03["SUB-PATTERN<br/>Parsing / edge cases<br/>1 problem(s)"]
  Sub03 --> Sub03A01["ANCHOR<br/>rank 164: String To Integer Atoi"]
```
