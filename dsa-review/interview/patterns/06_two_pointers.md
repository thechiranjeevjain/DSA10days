...
flowchart TD
  ...
  Sub01 --> Sub01A01["ANCHOR<br/>rank 110: Longest Palindromic Substring"]
  Invariant --> Sub02["SUB-PATTERN<br/>Linked list two pointers<br/>1 problem(s)"]
  Sub02 --> Sub02A01["ANCHOR<br/>rank 109: Remove Nth Node From End of List"]
  Invariant --> Sub03["SUB-PATTERN<br/>Partition / Dutch flag<br/>1 problem(s)"]
  Sub03 --> Sub03A01["ANCHOR<br/>rank 59: Sort Colors"]
  Invariant --> Sub04["SUB-PATTERN<br/>Two pointers<br/>2 problem(s)"]
  Sub04 --> Sub04A01["ANCHOR<br/>rank 10: Valid Palindrome"]
  Sub04 --> Sub04A02["ANCHOR<br/>rank 13: Container With Most Water"]
  Invariant --> Sub05["SUB-PATTERN<br/>Two pointers / hash<br/>1 problem(s)"]
  Sub05 --> Sub05A01["ANCHOR<br/>rank 12: Two Sum II - Input Array Is Sorted"]
  Invariant --> Sub06["SUB-PATTERN<br/>Two pointers / stack<br/>1 problem(s)"]
  Sub06 --> Sub06A01["ANCHOR<br/>rank 14: Trapping Rain Water"]
```
...
| 109 | Phase 3 - Important | Remove Nth Node From End of List | Linked list two pointers | [Java](../../../src/main/java/org/chijai/day4/LinkedList/session1/Intersection.java) | [LC](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) | Shrink the search space by moving the pointer that can still improve the answer. | Initialize pointers, compare current state, move the pointer whose movement is justified. |
| 110 | Phase 3 - Important | Longest Palindromic Substring | Expand around center | [Java](../../../src/main/java/org/chijai/day3/session3/LongestPalindromicSubstring.java) | [LC](https://leetcode.com/problems/longest-palindromic-substring/) | Expand around every odd and even center and keep the longest span. | For each index, expand(i,i) and expand(i,i+1), update best start/length. |
