...
flowchart TD
  ...
  Sub01 --> Sub01A01["ANCHOR<br/>rank 203: Design Redis"]
  Invariant --> Sub02["SUB-PATTERN<br/>LLD / domain modeling<br/>1 problem(s)"]
  Sub02 --> Sub02A01["ANCHOR<br/>rank 201: Design Fraud Pattern Detection"]
  Invariant --> Sub03["SUB-PATTERN<br/>LLD / rate limiting<br/>1 problem(s)"]
  Sub03 --> Sub03A01["ANCHOR<br/>rank 204: Design Token Bucket Rate Limiter"]
  Invariant --> Sub04["SUB-PATTERN<br/>LLD / URL shortener<br/>1 problem(s)"]
  Sub04 --> Sub04A01["ANCHOR<br/>rank 199: Encode And Decode Tinyurl"]
  Invariant --> Sub05["SUB-PATTERN<br/>LLD/API integration<br/>1 problem(s)"]
  Sub05 --> Sub05A01["ANCHOR<br/>rank 202: Api Integration Example"]
```
...
|---:|---|---|---|---|---|---|---|
| 199 | Phase 5 - If Time | Encode And Decode Tinyurl | LLD / URL shortener | [Java](../../../src/main/java/org/chijai/design/lld/DesignUrlShortner.java) | [LC](https://leetcode.com/problems/encode-and-decode-tinyurl/) | Encode creates a stable short key mapped to the original URL; decode is a map lookup. | Generate/increment key, store key->longUrl, return domain/key; decode extracts key and reads map. |
