...
flowchart TD
  ...
  Sub04 --> Sub04A01["ANCHOR<br/>rank 151: Permutations"]
  Invariant --> Sub05["SUB-PATTERN<br/>Position-choice backtracking<br/>1 problem(s)"]
  Sub05 --> Sub05A01["ANCHOR<br/>rank 150: Letter Combinations Of A Phone Number"]
  Invariant --> Sub06["SUB-PATTERN<br/>Sorted duplicate-aware permutations<br/>1 problem(s)"]
  Sub06 --> Sub06A01["ANCHOR<br/>rank 187: Permutations II"]
```
