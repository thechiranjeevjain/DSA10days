...
flowchart TD
  ...
  Invariant --> Sub01["SUB-PATTERN<br/>BST inorder<br/>5 problem(s)"]
  Sub01 --> Sub01A01["ANCHOR<br/>rank 27: Kth Smallest Element In A BST"]
  Sub01 --> Sub01A02["ANCHOR<br/>rank 107: Kth Smallest Element In BST"]
  Sub01 --> Sub01A03["ANCHOR<br/>rank 117: Recover Binary Search Tree"]
  ...
  Sub05 --> Sub05A01["ANCHOR<br/>rank 73: Serialize And Deserialize Binary Tree"]
  Invariant --> Sub06["SUB-PATTERN<br/>Tree DFS / stack<br/>4 problem(s)"]
  Sub06 --> Sub06A01["ANCHOR<br/>rank 16: Validate Binary Search Tree"]
  Sub06 --> Sub06A02["ANCHOR<br/>rank 64: Binary Tree Inorder Traversal"]
  ...
  Sub07 --> Sub07A02["ANCHOR<br/>rank 193: Lowest Common Ancestor Of A Binary Tree Ii"]
  Sub07 --> Sub07A03["ANCHOR<br/>rank 194: Lowest Common Ancestor Of A Binary Tree Iii"]
  Invariant --> Sub08["SUB-PATTERN<br/>Tree DFS/BFS<br/>1 problem(s)"]
  Sub08 --> Sub08A01["ANCHOR<br/>rank 65: Invert Binary Tree"]
  Invariant --> Sub09["SUB-PATTERN<br/>Tree path DFS / global answer<br/>5 problem(s)"]
  Sub09 --> Sub09A01["ANCHOR<br/>rank 29: Path Sum Iii"]
  Sub09 --> Sub09A02["ANCHOR<br/>rank 67: Sum Root To Leaf Numbers"]
  Sub09 --> Sub09A03["ANCHOR<br/>rank 93: Binary Tree Maximum Path Sum"]
  Invariant --> Sub10["SUB-PATTERN<br/>Tree recursion / hashmap index<br/>4 problem(s)"]
  Sub10 --> Sub10A01["ANCHOR<br/>rank 66: Construct Binary Search Tree From Preorder Traversal"]
  Sub10 --> Sub10A02["ANCHOR<br/>rank 80: Verify Preorder Serialization Of A Binary Tree"]
  Sub10 --> Sub10A03["ANCHOR<br/>rank 90: Construct Binary Tree From Inorder And Postorder Traversal"]
```
...
| 27 | Phase 1 - No Red Flags | Kth Smallest Element In A BST | BST inorder | [Java](../../../src/main/java/org/chijai/day6/trees/session2/RecoverBST.java) | [LC](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) | BST inorder gives ascending values; kth visited is the answer. | Iterative inorder with stack, decrement k on visit, return when k hits zero. |
