...
| 96 | Phase 3 - Important | Sliding Window Maximum | Stack/queue design | [Sliding Window Maximum](../../../src/main/java/org/chijai/day5/stack/session2/SlidingWindowMaximum.java) | [Sliding Window Maximum](https://leetcode.com/problems/sliding-window-maximum/) | A decreasing deque stores candidate indices; front is always the current window maximum. | Drop out-of-window front, pop smaller/equal from back, push index, read front after first window. |
