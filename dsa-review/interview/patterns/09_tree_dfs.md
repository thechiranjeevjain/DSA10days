...
flowchart TD
  ...
  Sub05 --> Sub05A01["ANCHOR<br/>rank 118: All Nodes Distance K in Binary Tree"]
  Invariant --> Sub06["SUB-PATTERN<br/>Tree converted to graph + BFS spread<br/>1 problem(s)"]
  Sub06 --> Sub06A01["ANCHOR<br/>rank 119: Amount of Time for Binary Tree to Be Infected"]
  ...
  Sub07 --> Sub07A03["ANCHOR<br/>rank 112: Binary Tree Postorder Traversal"]
  ...
  Sub10 --> Sub10A03["ANCHOR<br/>rank 97: Binary Tree Maximum Path Sum"]
  ...
  Sub11 --> Sub11A03["ANCHOR<br/>rank 94: Construct Binary Tree From Inorder And Postorder Traversal"]
```
