...
|---:|---|---|---|---|---|---|---|
| 139 | Should | Design Add And Search Words Data Structure | Trie + DFS wildcard | [Java](../../../src/main/java/org/chijai/day10/session1/trie/TrieWordDictionary.java) | [LC](https://leetcode.com/problems/design-add-and-search-words-data-structure/) | Each node is a prefix; branch only when wildcard or board search requires it. | Insert words by characters; search follows children and DFS branches on wildcard/board. |
| 162 | If Time | Hotel Reviews | Trie / ranking | [Java](../../../src/main/java/org/chijai/day10/session1/trie/HotelReviews.java) | - | Each node is a prefix; branch only when wildcard or board search requires it. | Insert words by characters; search follows children and DFS branches on wildcard/board. |
