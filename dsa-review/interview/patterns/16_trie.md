...
flowchart TD
  ...
  Sub01 --> Sub01A02["ANCHOR<br/>rank 164: Maximum XOR With an Element From Array"]
  Sub01 --> Sub01A03["ANCHOR<br/>rank 165: Maximum Genetic Difference Query"]
  Invariant --> Sub02["SUB-PATTERN<br/>Every-prefix-terminal trie<br/>1 problem(s)"]
  Sub02 --> Sub02A01["ANCHOR<br/>rank 159: Longest Word in Dictionary"]
  Invariant --> Sub03["SUB-PATTERN<br/>Prefix aggregate with overwrite delta<br/>1 problem(s)"]
  Sub03 --> Sub03A01["ANCHOR<br/>rank 163: Map Sum Pairs"]
  Invariant --> Sub04["SUB-PATTERN<br/>Prefix node + lexicographic DFS top 3<br/>1 problem(s)"]
  Sub04 --> Sub04A01["ANCHOR<br/>rank 161: Search Suggestions System"]
  Invariant --> Sub05["SUB-PATTERN<br/>Reversed suffix trie<br/>1 problem(s)"]
  Sub05 --> Sub05A01["ANCHOR<br/>rank 162: Short Encoding of Words"]
  Invariant --> Sub06["SUB-PATTERN<br/>Shortest terminal prefix<br/>1 problem(s)"]
  Sub06 --> Sub06A01["ANCHOR<br/>rank 160: Replace Words"]
  Invariant --> Sub07["SUB-PATTERN<br/>Single-branch prefix walk<br/>1 problem(s)"]
  Sub07 --> Sub07A01["ANCHOR<br/>rank 158: Longest Common Prefix"]
  ...
  Sub09 --> Sub09A01["ANCHOR<br/>rank 183: Hotel Reviews"]
...
| 166 | Phase 5 - If Time | Count Pairs With XOR in a Range | Binary trie / bit | [Java](../../../src/main/java/org/chijai/day10/session1/trie/MaximumXOR.java) | [LC](https://leetcode.com/problems/count-pairs-with-xor-in-a-range/) | Count pairs with XOR < bound using bitwise trie prefixes, then subtract low from high+1. | For each num, add countLessThan(high+1) - countLessThan(low), then insert num. |
| 183 | Phase 5 - If Time | Hotel Reviews | Trie / ranking | [Java](../../../src/main/java/org/chijai/day10/session1/trie/HotelReviews.java) | - | Use trie or keyword set to count good words per review, then rank hotels by score. | Normalize review words, count keyword hits, aggregate per hotel, sort by score and id. |
