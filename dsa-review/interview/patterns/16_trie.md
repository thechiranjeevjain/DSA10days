...
flowchart TD
  ...
  Sub01 --> Sub01A01["ANCHOR<br/>rank 162: Maximum XOR of Two Numbers in an Array"]
  ...
  Sub09 --> Sub09A01["ANCHOR<br/>rank 191: Hotel Reviews"]
...
| 191 | Phase 5 - If Time | Hotel Reviews | Trie / ranking | [Java](../../../src/main/java/org/chijai/day10/session1/trie/HotelReviews.java) | - | Use trie or keyword set to count good words per review, then rank hotels by score. | Normalize review words, count keyword hits, aggregate per hotel, sort by score and id. |
