...
| 72 | Phase 3 - Important | Burn Binary Tree | Tree + graph BFS | [Java](../../../src/main/java/org/chijai/day6/trees/session2/BurnBinaryTree.java) | - | Treat the tree as an undirected graph from the target node and BFS by minutes. | Build parent links, start BFS from target, expand left/right/parent, count levels. |
