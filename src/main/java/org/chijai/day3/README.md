...
| Session 2 | Prefix/suffix, exact-K counting and greedy arrays | [Product Except Self](session2/prefix/suffix/ProductOfArrayExceptSelf.java), [Nice Subarrays](session2/prefix/suffix/NiceSubArrays.java), [Gas Station](../day1/Arrays/session4/Intervals/GasStation.java), [Minimum Platforms](../day1/Arrays/session4/Intervals/MinimumPlatforms.java), [Count Unique Chars](session2/prefix/suffix/CountUniqueChars.java) |
