...
| Session 2 | Prefix/suffix, exact-K counting and greedy arrays | [Product Except Self](session2/ProductOfArrayExceptSelf.java), [Nice Subarrays](session2/NiceSubArrays.java), [Gas Station](session2/GasStation.java), [Minimum Platforms](session2/MinimumPlatforms.java), [Count Unique Chars](session2/CountUniqueChars.java) |
